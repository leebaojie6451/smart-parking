...
@Api(tags = {"用户支付账号管理"})
public interface CfUserPaymentAgencySwagger {
    ...
    public ResponseResult add(CfUserPaymentAgencyForm cfUserPaymentAgencyForm);
    ...
    public ResponseResult update(CfUserPaymentAgencyForm cfUserPaymentAgencyForm);
