...
public interface CfCarParkCarTypeSwagger {
    ...
    public ResponseResult add(@RequestBody CfCarParkCarTypeForm cfCarParkCarTypeForm);
    ...
    public ResponseResult update(@RequestBody CfCarParkCarTypeForm cfCarParkCarTypeForm);
