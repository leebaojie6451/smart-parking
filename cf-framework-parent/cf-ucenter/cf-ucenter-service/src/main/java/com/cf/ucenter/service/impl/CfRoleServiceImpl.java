...
public class CfRoleServiceImpl implements CfRoleService {
    ...
    @Override
    public List<CfRole> getListByQuery(CfRoleQuery cfRoleQuery) {
        return cfRoleMapper.selectByExample(getExampleByQuery(cfRoleQuery));
    }

    @Override
    public Integer countByQuery(CfRoleQuery cfRoleQuery) {
        cfRoleQuery.setPage(null);
        return cfRoleMapper.countByExample(getExampleByQuery(cfRoleQuery));
    }

    @Override
    public Integer deleteByQuery(CfRoleQuery cfRoleQuery) {
        return cfRoleMapper.deleteByExample(getExampleByQuery(cfRoleQuery));
    }
}
