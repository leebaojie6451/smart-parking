...
public interface CfRoleService {
    ...
    CfRoleExample getExampleByQuery(CfRoleQuery cfRoleQuery);

    List<CfRole> getListByQuery(CfRoleQuery cfRoleQuery);

    Integer countByQuery(CfRoleQuery cfRoleQuery);

    Integer deleteByQuery(CfRoleQuery cfRoleQuery);
}
