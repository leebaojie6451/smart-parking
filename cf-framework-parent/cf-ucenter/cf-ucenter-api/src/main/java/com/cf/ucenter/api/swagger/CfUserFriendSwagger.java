...
public interface CfUserFriendSwagger {
    ...
    public ResponseResult applyAddFriend(String uid, String remark) throws Exception;
    ...
    public ResponseResult applyAddGroup(String groupId, String remark) throws Exception;
    ...
    public ResponseResult getMyFriendRequests(
            ...
            @Min(value = 3, message = "每页获取条数最小值3") @Max(value = 50, message = "每页获取条数最大值50") Integer limit) throws Exception;
    ...
    @ApiOperation(value = "获取即时通讯在线人数最少的服务器ip")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "authorization", value = "jwt串(请加\"Bearer \"前缀，注意有空格)", required = true, paramType = "header", dataType = "string"),
            @ApiImplicitParam(name = "lang", value = "语言(zh-中文[默认]/en-英文...更多见官网文档)", required = false, paramType = "header", dataType = "string")
    })
    public ResponseResult getMinChatLinkCountsServiceIp() throws Exception;
}
