...
public class CfUserFriendController implements CfUserFriendSwagger {
    ...
    @Override
    @RequestMapping(value = "getMinChatLinkCountsServiceIp", method = RequestMethod.GET)
    public ResponseResult getMinChatLinkCountsServiceIp() throws Exception {
        String minChatLinkCountsServiceIp = cfUserFriendAddLogService.getMinChatLinkCountsServiceIp();
        return new ResponseResult(CommonCode.SUCCESS, minChatLinkCountsServiceIp);
    }
}
